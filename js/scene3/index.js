...
var draft = function(text) {
  ...
  //init
  this.draft_canvas.setAttribute('width', wW);
  this.draft_canvas.setAttribute('height', wH);
  this.dcc.font = "150px 'ＭＳ Ｐゴシック'";
  this.dcc.fillStyle = "#FFFFFF";
  this.dcc.textAlign = 'left';
  this.dcc.textBaseline = 'top';
  this.dcc.fillText(text, 50, 200);
  
  this.data = this.dcc.getImageData(0, 0, wW, wH).data;
};
draft.prototype = {
  draw: function() {
...
var draft_data = new draft('abcdefghijklmnopqrstu'); //font 
/*
draft_data.draw();
