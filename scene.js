(function(){
    ...
    var SceneManager = Class( Object, {
         ...
         * @param {Scene} scene
         */
        add: function( path, scene ){
            this._map[path] = scene;
        },
     ...
     * @return {Scene}
     */
    Scene.add = function( path, scene ) {
        if( arguments.length<2 ) scene = new Scene();
        sceneManager.add.call( sceneManager, path, scene );
        return scene;
    }
